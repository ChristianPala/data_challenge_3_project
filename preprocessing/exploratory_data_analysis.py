...
if __name__ == '__main__':
    ...
    # plt.figure(figsize=(10, 10))
    sns.distplot(df['Quantity'], kde=False, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.distplot(df['Price'], kde=False, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df['Country'], color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df[df['Country'] != 'United Kingdom']['Country'], color='b')
    plt.xticks(rotation=90)
    # give more space to the x_labels:
    plt.subplots_adjust(bottom=0.3)
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df['InvoiceDate'].dt.month, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df['InvoiceDate'].dt.day, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df['InvoiceDate'].dt.dayofweek, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    sns.countplot(x=df['InvoiceDate'].dt.hour, color='b')
    ...
    # plt.figure(figsize=(10, 10))
    plt.scatter(x=x, y=df_agg['NumberOfPurchases'], marker='.', c='b')
    ...
    # plt.figure(figsize=(10, 10))
    plt.scatter(x, df_agg['TotalSpent'], marker='.', c='b')
